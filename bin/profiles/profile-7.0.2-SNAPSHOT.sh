...
export PUNCH_RESOURCECTL_IMG=ghcr.io/punchplatform/resourcectl:7.0.2-SNAPSHOT
export PUNCH_STORMLINE_IMG=ghcr.io/punchplatform/stormline:7.0.2-SNAPSHOT
